...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "Ez a felület a stratégiai vagyonkezelés és a piaci információszerzés központja.\n\n"
...
async def daily_intel_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "👉 *A teljes elemzésért lépjen be a Vault-ba.*"
    )
...
async def wallet_help_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "1. Nyissa meg a **VIP Vault** oldalt asztali gépen vagy mobil böngészőben.\n"
        "2. Kattints a **'Connect Wallet'** gombra.\n"
